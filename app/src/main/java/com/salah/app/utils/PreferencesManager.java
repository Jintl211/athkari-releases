...
public class PreferencesManager {
    ...
    // ✅ مفتاح أذان الفجر منفصل
    private static final String K_FAJR_ADHAN_FILE = "fajr_adhan_file";
    ...
    public static UserSettings load(Context ctx) {
        ...
        // ✅ أذان الفجر منفصل
        s.selectedFajrAdhanFile  = p.getString(K_FAJR_ADHAN_FILE, s.selectedFajrAdhanFile);
    ...
    public static void save(Context ctx, UserSettings s) {
        prefs(ctx).edit()
            ...
            // ✅ أذان الفجر منفصل
            .putString(K_FAJR_ADHAN_FILE, s.selectedFajrAdhanFile)
